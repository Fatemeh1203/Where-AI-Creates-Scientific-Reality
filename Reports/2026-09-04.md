...
**Date / تاریخ:** 2026-09-04  
**Papers today / مقالات امروز:** 12  
**Average rating / میانگین امتیاز:** 3.08 / 5  
**Hot areas / حوزه‌های داغ:** Distributed Acoustic Sensing (DAS) (4), Fiber Bragg Grating (FBG) (3), Distributed Fiber Optic Sensing (DFOS) (3), Photonic / Silicon-Photonics Sensors (2)
...
- Previous report / گزارش قبلی: **2026-09-03** with 24 analysed papers.
...
### 1. Phase-Locked Time-Stretch Optical Coherence Tomography for Contrast-Enhanced Retinal Microangiography
...
---
### 2. Fully Distributed Fiber-Optic Sensing Enabled by Kalman Filtering
...
---
### 3. Comparative analysis of fiber Bragg grating filter losses inscribed by continuous wave UV and femtosecond-IR lasers for astrophotonics
...
---
### 4. Numerical Model of a Multiple-Input-Multiple-Output Distributed Acoustic Sensing System with Joint Phase and Birefringence Estimation
...
---
### 6. Ground-to-Cable Strain Transfer in Unburied DAS on Earth and the Moon
...
---
### 7. Goos-Hanchen-Shift Photonic Sensor for Nanometer-Scale Delayering and Tamper Detection in Semiconductor Packages
...
---
### 8. A note on the complexity of random subspace model-based methods for derivative-free optimization
...
---
### 9. TOBYQA: A Trust-Region Method for Derivative-Free Optimization on Time-Varying Functions
...
---
### 10. Touch-based wearable cortisol monitoring via an interface-engineered hydrogel fiber sensor
...
---
### 11. Fiber Bragg Grating Whiskers for Bioinspired Hydrodynamic Perception on Underwater Robots
...
---
### 12. A Continuous Payload-Bearing Discrete Multitone Modulation Framework for Fiber-Optic Integrated Sensing and Communication
