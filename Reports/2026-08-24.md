...
**Date / تاریخ:** 2026-08-24  
**Papers today / مقالات امروز:** 12  
**Average rating / میانگین امتیاز:** 3.0 / 5  
**Hot areas / حوزه‌های داغ:** Distributed Fiber Optic Sensing (DFOS) (3), Distributed Acoustic Sensing (DAS) (3), Quantum Fiber Sensors (2), Fiber Bragg Grating (FBG) (2), Optical Fiber Sensors (1)
...
- Previous report / گزارش قبلی: **2026-08-23** with 24 analysed papers.
...
### 1. Control of single quantum emitters in bio-inspired aperiodic nano-photonic devices
...
---
### 2. Revealing multiple classes of stable quantum emitters in hexagonal boron nitride with correlated cathodoluminescence, photoluminescence, and strain mapping
...
---
### 4. Phase-Locked Time-Stretch Optical Coherence Tomography for Contrast-Enhanced Retinal Microangiography
...
---
### 5. Fully Distributed Fiber-Optic Sensing Enabled by Kalman Filtering
...
---
### 6. Comparative analysis of fiber Bragg grating filter losses inscribed by continuous wave UV and femtosecond-IR lasers for astrophotonics
...
---
### 7. Numerical Model of a Multiple-Input-Multiple-Output Distributed Acoustic Sensing System with Joint Phase and Birefringence Estimation
...
---
### 8. Comparative Analysis of Spread-Spectrum Codes for Fibre-Optic Distributed Acoustic Sensing
...
---
### 9. Ground-to-Cable Strain Transfer in Unburied DAS on Earth and the Moon
...
---
### 10. Goos-Hanchen-Shift Photonic Sensor for Nanometer-Scale Delayering and Tamper Detection in Semiconductor Packages
...
---
### 11. A note on the complexity of random subspace model-based methods for derivative-free optimization
...
---
### 12. TOBYQA: A Trust-Region Method for Derivative-Free Optimization on Time-Varying Functions
